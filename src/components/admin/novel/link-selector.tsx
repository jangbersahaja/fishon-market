...
export const LinkSelector = ({ open, onOpenChange }: LinkSelectorProps) => {
  ...
  return (
    <Popover modal={true} open={open} onOpenChange={onOpenChange}>
        ...
        >
          ...
          <p
            className={`underline decoration-gray-400 underline-offset-4 ${
              editor.isActive("link") ? "text-[#ec2227]" : ""
            }`}
          >
            Link
          </p>
      ...
      <PopoverContent
        align="start"
        className="w-60 rounded-md border border-gray-200 bg-white p-0 shadow-md"
        sideOffset={10}
      >
        <form
          onSubmit={(e) => {
        ...
        >
          ...
          {editor.getAttributes("link").href ? (
            ...
            <Button size="icon" className="h-8 bg-[#ec2227] hover:bg-[#d11e22]">
