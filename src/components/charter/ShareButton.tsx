    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className={`rounded-full bg-white/10 hover:bg-white/20 text-white ${className}`}
        >
          <Share2 className="w-6 h-6" />
          <span className="sr-only">{t("gallery.shareCharter")}</span>
        </Button>
      </DropdownMenuTrigger>
        ...
        <DropdownMenuItem onClick={handleCopyLink}>
          {copied ? (
            <>
              ...
              <span className="text-green-600">{tShare("linkCopied")}</span>
            </>
          ) : (
            <>
